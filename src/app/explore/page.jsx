...
export default function Explore() {
  ...
  const { searchUser, datas, postSearchHistory, getSearchHistory, history, deleteSearchHistory, clearSearchHistory, loading } = useDrawerStore()
  ...
  return (
    <>
      <div className="md:hidden pt-3 px-3 pb-2   mb-3 fixed top-0 left-0 right-0 z-20 bg-white shadow-md">
        <div className='flex items-center justify-between gap-3 '>
          <div className='rounded-[5px] px-3 bg-[#EFEFEF] flex items-center border w-[100%]'>
            <SearchIcon />
            <input
          ...
          <button onClick={handleClose} style={{ display: openSearchDiv ? 'block' : 'none' }}>Отмена</button>
...

        {
          ...
          <div className='flex flex-col gap-5 fixed top-[60px] left-0 right-0 bg-white z-10 px-3 py-5 shadow-lg rounded-lg h-[100vh]'>
