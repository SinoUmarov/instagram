  ...
  return (
    <>
      <div
        ...
        style={{ backgroundColor: theme.palette.background.paper }} // Apply theme background
      >
        <div className="flex items-center justify-between gap-3 ">
          <div
            className="rounded-[5px] px-3 flex items-center border w-[100%]"
            style={{
              backgroundColor: theme.palette.action.hover, // Use a subtle background for input
              borderColor: theme.palette.divider, // Apply theme border color
            }}
          >
            <SearchIcon sx={{ color: theme.palette.text.secondary }} /> {/* Icon color */}
            <input
              ...
              style={{
                backgroundColor: "transparent", // Make input background transparent to inherit parent
          ...
          >
            <div className="flex justify-between">
              ...
              <button
                ...
                style={{ color: theme.palette.primary.main }} // Use primary color for link-like button
              >
                Очистить все
              </button>
            </div>
      ...
      <div className="w-full max-w-[1000px] m-auto grid grid-cols-3 gap-[1px] mt-[65px] md:mt-5">
        {isLoading
          ...
          : Array.isArray(data) &&
            data.map((e, i) => (
              <Link
                key={i} // Key теперь на Link
                href={`/profile/${e?.userId}`} // Добавьте ссылку на профиль пользователя
              ...
              >
                <div // div теперь внутри Link
                  className="w-full h-full" // Убедитесь, что div занимает всю доступную область Link
                >
