          ...
          >
            <DialogContent className="flex flex-col gap-5 w-[450px] h-[445px] ">
              <Box className="flex flex-col gap-3">
                <button className="font-bold text-red-500 border-b border-[#e9e8e8] pb-2 ">Report</button>
                <button className="font-bold text-red-500 border-b border-[#e9e8e8] pb-2 ">Unfollow</button>
                <button className="border-b border-[#e9e8e8] pb-2" onClick={() => toggleSave(postId)}>Add to favorite</button>
                <button className="border-b border-[#e9e8e8] pb-2">Go to post</button>
                <button className="border-b border-[#e9e8e8] pb-2">Share to...</button>
                <button className="border-b border-[#e9e8e8] pb-2">Copy link</button>
                <button className="border-b border-[#e9e8e8] pb-2">Embed</button>
                <button className="border-b border-[#e9e8e8] pb-2">About this account</button>
                <button className="border-b border-[#e9e8e8] pb-2" onClick={handleClose}>Cancel</button>
              </Box>
            </DialogContent>
          </Dialog>
        </Fragment>
